...
//         for (int j = 1; j < 8; j++)
//         {
//             histall3d[mapxy[i][0]-1][mapxy[i][1]-1][j-1] = new TH1F(Form("ch_%i_x=%i_y=%i_z=%i",mapz[i][j],mapxy[i][0],mapxy[i][1],j),Form("ch_%i_x=%i_y=%i_z=%i",mapz[i][j],mapxy[i][0],mapxy[i][1],j),70,100,40000);
//             histall13d[mapxy[i][0]-1][mapxy[i][1]-1][j-1] = new TH1F(Form("before_ch_%i_x=%i_y=%i_z=%i",mapz[i][j],mapxy[i][0],mapxy[i][1],j),Form("before_ch_%i_x=%i_y=%i_z=%i",mapz[i][j],mapxy[i][0],mapxy[i][1],j),70,100,40000);
